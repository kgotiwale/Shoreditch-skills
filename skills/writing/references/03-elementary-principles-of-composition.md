...
> Verbatim from Strunk, *The Elements of Style* (1918). Kept as a primary source, including its original punctuation and its generic "he". This is the default section to load: Rules 10-13 (active voice, positive form, concrete language, omit needless words) fix most prose.
